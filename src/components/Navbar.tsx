        ...
        <div className="flex items-center min-w-0 pr-4">
          <Link to="/" className="flex-shrink-0 flex items-center gap-2 sm:gap-3 group min-w-0">
            <img
              src={logo}
              alt="CampusFind Logo"
              className="h-6 w-6 sm:h-8 sm:w-8 object-contain transition-transform group-hover:scale-105 flex-shrink-0"
            />
            <span className="font-semibold text-lg sm:text-xl text-gray-900 tracking-tight truncate">CampusFind</span>
          </Link>

          {user && (
            <div className="hidden md:ml-8 md:flex md:space-x-4 flex-shrink-0">
              <Link
                to="/"
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
          {user ? (
            ...
            <div className="flex gap-2 sm:gap-3 flex-shrink-0">
              <Link
                to="/login"
                className="text-gray-600 hover:text-gray-900 hover:bg-gray-50 active:scale-95 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-sm font-medium transition-all duration-200 flex-shrink-0"
              >
                Log in
              </Link>
              <Link
                to="/register"
                className="bg-gray-900 text-white hover:bg-gray-800 active:scale-95 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-sm flex-shrink-0"
              >
                Sign up
              </Link>
            </div>
